  ...
  up: function (queryInterface, Sequelize) {
    return queryInterface.bulkInsert('Books', [
      ...
      },
      {
        ...
        categoryId: 1,
        image: 'https://res.cloudinary.com/dcl7tqhww/image/upload/v1509139550/dre2kfd1k36yfdsnihbf.png',
        createdAt : new Date(),
        updatedAt : new Date(),
      },
      {
        ...
        categoryId: 1,
        image: 'https://res.cloudinary.com/dcl7tqhww/image/upload/v1509139539/w9wpuonkyguo32i90mg8.png',
        createdAt : new Date(),
        updatedAt : new Date(),
      },
      {
        ...
        categoryId: 1,
        image: 'https://res.cloudinary.com/dcl7tqhww/image/upload/v1509139546/vzlhfphllnevgtff3oej.png',
        createdAt : new Date(),
        updatedAt : new Date(),
      },
      {
