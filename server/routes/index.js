...
Router.get('/api/users', usersController.list); // Listing all users
...
Router.get('/api/users/:userId/books', borrowsController.listNotReturned); // Route to list borrowed but not returned book
